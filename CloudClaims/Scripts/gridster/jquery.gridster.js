...
;(function($, window, document, undefined) {
    ...
    var defaults = {
        ...
        serialize_params: function($w, wgd) {
            return {
                ...
                size_x: wgd.size_x,
                size_y: wgd.size_y,
                elementtype: wgd.eltype,
                elementtypeid: wgd.eltypeid
            };
        },
        collision: {},
        draggable: {
    ...
    */
    fn.add_widget = function(html, size_x, size_y, col, row, elementtype, elementtypeid) {
        var pos;
        size_x || (size_x = 1);
        size_y || (size_y = 1);
        ...
        var $w = $(html).attr({
                ...
                'data-sizex' : size_x,
                'data-sizey': size_y,
                'data-elementtype': elementtype || 'notset',
                'data-elementtypeid': elementtypeid || '0'
        ...
        //Ashish - Edited this BEGIN
        if (!size_y) {
            this.add_faux_rows(pos.row);
        } else {
            this.add_faux_rows(size_y);
        }
        //Ashish - Edited this END
        //this.add_faux_cols(pos.size_x);

        this.set_dom_grid_height(2);
    ...
    */
    fn.resize_widget = function($widget, size_x, size_y) {
        ...
        //this.set_dom_grid_height(633);  //Ashish added
        this.init();    //Ashish added
        return $widget;
    };
    ...
    */
    fn.serialize = function($widgets) {
        ...
        $widgets.each($.proxy(function (i, widget) {
            var elementType = $(widget).attr('data-elementtype');
            var elementTypeID = $(widget).attr('data-elementtypeid');
            var tempItembeingPushed = this.options.serialize_params($(widget), $(widget).coords().grid);
            tempItembeingPushed.elementtype = elementType;
            tempItembeingPushed.elementtypeid = elementTypeID;
            result.push(tempItembeingPushed);
        }, this));
        return result;
    };
    ...
    */
    fn.register_widget = function($el) {
        ...
        var wgd = {
            ...
            'eltype': $el.attr('data-elementtype'),
            'eltypeid': $el.attr('data-elementtypeid'),
            'el': $el
        };
        ...
        if (this.options.avoid_overlapped_widgets &&
            ...
            $el.attr({
                ...
                'data-elementtype': wgd.eltype,
                'data-elementtypeid': wgd.eltypeid
            });
        }
    ...
    */
    fn.set_placeholder = function(col, row) {
        ...
        //console.log('updating preview holder: r' + row + ' and c' + col);
        //console.log(this.$preview_holder);
    ...
    */
    fn.move_widget_to = function($widget, row) {
        ...
        $widget.css('top', ''); //Ashish - jQuery UI conflict fix
    ...
    */
    fn.set_dom_grid_height = function (x) {
